      ...
      <div class="block-grid row" id="config-cards">
         ...
         <div class="tab-content">
            <div id="menu-1-0" class="tab-pane fade in active">
               ...
               <textarea class="form-control" data-config-file="<?= $cfg_file='client-conf/linux/client.ovpn' ?>" name="" id="" cols="30" rows="20"><?= file_get_contents($cfg_file) ?></textarea>
            ...
            <div id="menu-1-2" class="tab-pane fade">
               ...
               <textarea class="form-control" data-config-file="<?= $cfg_file='client-conf/macos/client.ovpn' ?>" name="" id="" cols="30" rows="20"><?= file_get_contents($cfg_file) ?></textarea>
               <?= getHistory($cfg_file, ++$accId) ?>
